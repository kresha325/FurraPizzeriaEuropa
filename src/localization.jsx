...
const translations = {
  sq: {
    ...
    menuCardPizzaDesc: 'Pizza me përbërës të freskët dhe recetë tradicionale.',
  ...
  en: {
    ...
    menuCardPizzaDesc: 'Pizza with fresh ingredients and traditional recipe.',
